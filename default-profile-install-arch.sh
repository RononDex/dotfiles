...
sudo pacman -S powerline-fonts fakeroot gcc boost ffmpeg make cmake otf-fira-mono otf-fira-sans ttf-fira-codea ttf-fira-mono ttf-fira-sans bash-completion zsh zsh-completions automake m4 autoconf --noconfirm --needed
...
sudo pacman -S lightdm-webkit-theme-litarvan feh xfce4-terminal picom alsa pulseaudio pulseaudio-jack pulseaudio-alsa pavucontrol arc-gtk-theme arc-icon-theme nautilus --noconfirm --needed
...
sudo pacman -S python python2 python-pip samba opencv pkgconfig gtest gmock wxgtk2 libmpdclient bc ranger xorg-server binutils keychain --needed --noconfirm
...
sudo pacman -S ueberzug autoconf keyutils automake bison openconnect networkmanager-openconnect ksshaskpass --needed --noconfirm
sudo pacman -S libvips lftp --needed --noconfirm
