...
sudo xbps-install -Sy linux-firmware-amd network-manager-applet lightdm lightdm-gtk3-greeter lightdm-webkit2-greeter light-locker firefox arc-theme arc-icon-theme nautilus 
