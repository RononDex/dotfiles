...
sudo xbps-install -y python python3 python-pip samba opencv gtest wxWidgets-gtk3 libmpdclient branger binutils keychain lftp
...
sudo xbps-install -y tar zip xz keyutils bc elfutils-devel flex gmp-devel kmod libmpc-devel openssl-devel perl uboot-mkimage cpio pahole python3 vips
